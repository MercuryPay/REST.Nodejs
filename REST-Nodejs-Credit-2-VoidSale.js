...
var jsonObject = JSON.stringify({
    'InvoiceNo':'1',
    'RefNo':'0035', // use from Response in the relevant transaction
    'Memo':'REST Node.js Credit VoidSale Sample Code', // replace with your product name and version number
    'Purchase':'1.01',
...
var optionspost = {
    ...
    port : 443,
    path : '/PaymentsAPI/Credit/VoidSale',
    method : 'POST',
    headers : postheaders
};
