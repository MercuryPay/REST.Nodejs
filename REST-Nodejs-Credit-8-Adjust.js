...
var jsonObject = JSON.stringify({
    'InvoiceNo':'1',
    'RefNo':'0023', // use from Response in the relevant transaction
    'Memo':'REST Node.js Credit Adjust Sample Code', // replace with your product name and version number
    'Purchase':'1.25',
...
var optionspost = {
    ...
    port : 443,
    path : '/PaymentsAPI/Credit/Adjust',
    method : 'POST',
    headers : postheaders
};
