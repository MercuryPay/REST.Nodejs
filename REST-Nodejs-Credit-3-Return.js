...
var jsonObject = JSON.stringify({
    'InvoiceNo':'1',
    'RefNo':'1',
    'Memo':'REST Node.js Credit Return Sample Code', // replace with your product name and version number
    'Purchase':'1.01',
    'Frequency':'OneTime',
...
var optionspost = {
    ...
    port : 443,
    path : '/PaymentsAPI/Credit/Return', // do not use a Return to void a txn in the current open batch
    method : 'POST',
    headers : postheaders
};
