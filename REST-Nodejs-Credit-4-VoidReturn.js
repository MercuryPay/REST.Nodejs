...
var jsonObject = JSON.stringify({
    'InvoiceNo':'1',
    'RefNo':'0022', // from Credit-Sale transaction you want to VoidReturn
    'Memo':'REST Node.js Credit VoidReturn Sample Code', // replace with your product name and version number
    'Purchase':'1.00',
    'AuthCode':'VI0100', // from Credit-Sale transaction you want to VoidReturn
    'Frequency':'OneTime',
...
var optionspost = {
    ...
    port : 443,
    path : '/PaymentsAPI/Credit/VoidReturn',
    method : 'POST',
    headers : postheaders
};
